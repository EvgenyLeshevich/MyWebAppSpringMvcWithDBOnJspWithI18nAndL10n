                                ...
                                <div class="col-lg-9 pb-4">
                                    ...
                                    <div class="tab-content px-1 pt-2">
                                        <div class="tab-pane active" id="tab1">
                                            <p> Welcome to my custom Bootstrap 4 test page that is a simple way to see various Bootstrap component examples. Customize Bootstrap with <a href="https://themestr.app">Themestr.app</a>. </p>
